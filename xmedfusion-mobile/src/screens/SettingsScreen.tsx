...
import { shellBackground, surfaceCard } from '../theme/ui';
  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.subtitle}>System configuration, access, and visual preferences</Text>
      </View>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        <View style={s.section}>
          ...
          <View style={s.sectionCard}>
            <TouchableOpacity style={s.settingRow} onPress={toggleTheme} activeOpacity={0.8}>
        ...
        <TouchableOpacity style={s.logoutButton} onPress={signOut} activeOpacity={0.85}>
...
const styles = (theme: ReturnType<typeof useTheme>['theme']) =>
  StyleSheet.create({
    ...
    title: { color: theme.foreground, fontSize: typography['2xl'], fontFamily: fontFamily.bold },
    subtitle: { color: theme.mutedForeground, fontSize: typography.sm, marginTop: 2, fontFamily: fontFamily.regular },
    scroll: { paddingHorizontal: spacing.lg, paddingBottom: spacing.xxl + 84 },
    section: { marginBottom: spacing.lg },
    sectionTitle: { color: theme.mutedForeground, fontSize: typography.xs, letterSpacing: 1, textTransform: 'uppercase', marginBottom: spacing.sm, marginLeft: 4, fontFamily: fontFamily.semiBold },
    sectionCard: { ...surfaceCard(theme), overflow: 'hidden' },
    ...
    settingText: { flex: 1 },
    settingLabel: { color: theme.foreground, fontSize: typography.base, fontFamily: fontFamily.medium },
    ...
    logoutText: { color: theme.destructive, fontSize: typography.base, fontFamily: fontFamily.semiBold },
